...
class CourseClass:
    def __init__(self,root):
        ...
        #====Entry Fields==========
        self.txt_corseName=Entry(self.root,textvariable=self.var_course,font=("goudy old style",15,"bold"),bg="lightyellow")
        ...
        self.txt_desription=Text(self.root,font=("goudy old style",15,"bold"),bg="lightyellow")
